...
import com.google.pubsub.v1.SubscriptionName as SubscriptionName
...
class SubscriberController {
    ...
    def getMessages(String subscriptionId) {
        render subscriberService.getMessages(subscriptionId)
    }
